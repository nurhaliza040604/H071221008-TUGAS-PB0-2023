...
public class TypeRacer {
    ...
    private String[] wordsToTypeList = { "Hidup adalah anugerah yang berharga. Nikmati setiap momen dan hargai kebahagiaan sederhana di sekitar kita" };
    // private String[] wordsToTypeList = { 
    ...
    public void setNewWordsToType() {
        ...
        // Jadi yang diambil itu langsung index kalimatnya
        wordsToType = wordsToTypeList[randomNumber];
    }

    // TODO 4 method addResult yang mana digunakan untuk menambahkan typer yang telah selesai (mengetik semua kata), ke dalam list race standing
